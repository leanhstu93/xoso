            ...
            <div class="css-tab-language js-tab-language js-tab-language-vi" data-code="vi">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-icon">
                        <?= Html::textInput('Template[seo_name]',$model->seo_name,array('class'=>'js__alias form-control')) ?>
...
<!--                End seo name-->
        ...
        <div class="panel-body container-fluid">
            ...
            <?= $form->field($model, 'image_pc',['template' => '<label class="control-label" for="template-image_pc">Hình PC</label>
<div class="input-group input-group-file js__select-image">{input}<span class="input-group-btn">
                      <span class="btn btn-success btn-file">
                        <i class="icon wb-upload" aria-hidden="true"></i>
            ...
            <?= $form->field($model, 'image_mobile',['template' => '<label class="control-label" for="template-image_mobile">Hình mobile</label>
<div class="input-group input-group-file js__select-image">{input}<span class="input-group-btn">
                      <span class="btn btn-success btn-file">
                        <i class="icon wb-upload" aria-hidden="true"></i>

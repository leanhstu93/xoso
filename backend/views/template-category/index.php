...
/* @var $searchModel app\models\Template */

$this->title = 'Danh sách danh mục template';
            ...
            <div class="panel-body">
                ...
                $gridColumns = [
                    ...
                    [
                        ...
                        'attribute'=>'active',
                        'vAlign'=>'middle',
                        'enum' => \frontend\models\TemplateCategory::listActive()
                    ],
                    [
                ...
                <?= GridView::widget([
                    ...
                    'itemLabelPlural' => 'Danh sách template'
                ]); ?>
            </div>
        </div>
    </div>
